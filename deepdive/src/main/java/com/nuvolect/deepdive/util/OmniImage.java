...
public class OmniImage {
    ...
    public static OmniFile makeThumbnail(OmniFile file) {
        ...
        InputStream is = VolUtil.getFileInputStream(file);
    ...
    public static Bitmap getThumbnailBitmap(OmniFile file) {
        ...
        if( thumbnailFile.exists()){
            ...
            try {
                ...
                LogUtil.logException(LogUtil.LogType.GALLERY,"error decoding bitmap preview",e);
            }
            return b;
        }
    ...
    public static OmniFile getThumbnailFile(OmniFile file) {
        ...
        String thumbPath = rootPath + VolUtil.dotThumbnailFolderName+ file.getHash();
